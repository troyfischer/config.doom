...
(defun +troy/compile-scss (project-plist)
  ...
  (shell-command "cd ~/blog/content/themes/theme && ./build.sh"))
...
(defun +troy/publish-blog-remote ()
  (interactive)
  (async-shell-command "rsync -L -e ssh -uvrz ~/blog/public/ root@troyfischer.net:/var/www/html/ --delete --exclude='.*' --chmod=Du=rwx,Dgo=rx,Fu=rw,Fog=r"))
